...
async function logAccount(message, user) {
    ...
    // writing to the file system dosent work in a aserverless environment

    console.log(`${message} at ${timeStamp} from user: ${user}`)
}
...
async function LogInfo(level,source,message){
    ...
    // }
    console.log(`${level} from source : ${source} \n ${message} at ${timeStamp} \n`)
}
